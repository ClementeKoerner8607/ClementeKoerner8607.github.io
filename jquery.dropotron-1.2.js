...
(function(jQuery) {
	...
	jQuery.dropotron = function(options) {
					...
					var settings = jQuery.extend({
				selectorParent:			null,								baseZIndex:				1000,								menuClass:				'dropotron',						expandMode:				'hover',							hoverDelay:				150,								hideDelay:				250,								openerClass:			'opener',							openerActiveClass:		'active',							submenuClassPrefix:		'dropotron-level-',					mode:					'slide',		    				speed:					'fast',								easing:					'swing',							alignment:				'left',								offsetX:				0,									offsetY:				0,									globalOffsetY:			0,									IEOffsetX:				0,									IEOffsetY:				0,									noOpenerFade:			false							}, options);
